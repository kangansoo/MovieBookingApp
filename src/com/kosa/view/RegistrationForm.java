...
public class RegistrationForm extends JPanel {
	...
	public RegistrationForm() {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				Window window = SwingUtilities.getWindowAncestor(RegistrationForm.this);
				if (window != null) {
	...
	private class RegistrationListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				JOptionPane.showMessageDialog(RegistrationForm.this, "회원가입 중 오류가 발생했습니다: " + e1.getMessage(), "오류",
